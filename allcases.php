...
$cases = $connection->query("SELECT * from cases");
?>
                                        ...
                                        while ($row = $cases->fetch_assoc()) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-success btn-sm delete-confirm" data-toggle="tooltip" title="Mark As Resolved" href="controllers/markresolved.php?id=<?php echo $case_id; ?>"> <i class="fa fa-check"> </i> </button>
